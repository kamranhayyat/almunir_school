    ...
    @if($student['status'] == 0)
        <form action="{{ route('edit-student', ['id' => base64_encode($student['id'])]) }}" method="POST">
            ...
            @forelse($student->std_complaints as $key => $complaint)
                <div class="display-4 pb-3 pt-3">Complaints</div>
                <div class="form-group">
            ...
            <div class="display-4 pb-3 pt-3" style="font-size:30px;">Lesson Plans</div>
            ...
            @forelse($student->materials as $key => $material)
                <div class="display-4 pb-3 pt-3">Study Material</div>
                <div class="form-group">
            ...
            @endforelse
            @if(file_exists( public_path() . '/uploads/results/'. $student['results']))
            <div class="form-group">
            ...
            {{-- @if(file_exists( public_path() . '/uploads/results/'. $student['invoices']))
            <div class="form-group">
            ...
            @if(file_exists( public_path() . '/uploads/results/'. $student['date_sheet']))
            <div class="form-group">
        ...
        @else
        <div class="display-3 text-center pt-5">Student View Blocked</div>
    @endif
@endsection